...
class MockAIProvider {
    ...
    async generateMatchAnalysis(prompt) {
        ...
        const valueHome = await this.evaluateBetValue(`Victoria ${prompt.homeTeam}`, '1X2 Match Winner', homeOdds, fairHomeProb);
        const valueOver = await this.evaluateBetValue('Más de 2.5 Goles', 'Totals (Over/Under)', 1.85, 0.58);
        return Promise.resolve({
...
//# sourceMappingURL=mockAi.provider.js.map