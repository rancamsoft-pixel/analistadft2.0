...
exports.ParlayCalculator = void 0;
class ParlayCalculator {
    ...
    static calculate(legs, _defaultStake = 10) {
        if (legs.length === 0) {
        ...
        const totalOddsDecimal = Number(legs.reduce((acc, leg) => acc * leg.odds, 1).toFixed(3));
        ...
        return {
            ...
            potentialPayout: (stake) => Number((stake * totalOddsDecimal).toFixed(2)),
            potentialProfit: (stake) => Number((stake * (totalOddsDecimal - 1)).toFixed(2)),
            warnings,
            isRecommended: ev > 2.0 && legs.length <= 4
        };
    }
}
exports.ParlayCalculator = ParlayCalculator;
//# sourceMappingURL=parlay.calculator.js.map