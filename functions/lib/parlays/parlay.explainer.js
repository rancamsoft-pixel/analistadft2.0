...
exports.ParlayExplainer = void 0;
const index_js_1 = require("../config/index.js");
const logger_js_1 = require("../utils/logger.js");
const retry_js_1 = require("../utils/retry.js");
const logger = new logger_js_1.StructuredLogger('ParlayExplainer');
...
class ParlayExplainer {
    /**
     * Genera explicaciones para los candidatos finalistas
     */
    static async explainFinalist(candidate, categoryName) {
     ...
     */
    static generateMockExplanation(candidate, categoryName) {
        ...
        const keyFactors = candidate.selections.map(s => {
     ...
     */
    static async callGeminiForExplanation(candidate, categoryName) {
        const url = `https://generativelanguage.googleapis.com/v1beta/models/${index_js_1.config.geminiModel}:generateContent?key=${index_js_1.config.apiKeys.gemini}`;
        const promptPayload = {
...
exports.ParlayExplainer = ParlayExplainer;
//# sourceMappingURL=parlay.explainer.js.map