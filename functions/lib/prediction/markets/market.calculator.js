...
exports.calc1X2Probabilities = calc1X2Probabilities;
exports.calc1X2Markets = calc1X2Markets;
exports.calcDoubleChanceMarkets = calcDoubleChanceMarkets;
exports.calcDrawNoBetMarkets = calcDrawNoBetMarkets;
exports.calcOverUnderMarkets = calcOverUnderMarkets;
exports.calcBTTSMarkets = calcBTTSMarkets;
exports.calculateAllMarkets = calculateAllMarkets;
const MAX_GOALS = 8;
// ---------------------------------------------------------------------------
// Probabilidades base 1X2 de la matriz
// ---------------------------------------------------------------------------
function calc1X2Probabilities(goalMatrix) {
    let home = 0;
    let draw = 0;
    let away = 0;
...
// 1X2
// ---------------------------------------------------------------------------
function calc1X2Markets(goalMatrix) {
...
// ---------------------------------------------------------------------------
function calcDoubleChanceMarkets(goalMatrix) {
    const { home, draw, away } = calc1X2Probabilities(goalMatrix);
    return [
        {
 ...
 */
function calcDrawNoBetMarkets(goalMatrix) {
 ...
 */
function calcOverUnderMarkets(goalMatrix) {
 ...
 */
function calcBTTSMarkets(goalMatrix) {
    let bttsYes = 0;
...
// ---------------------------------------------------------------------------
function calculateAllMarkets(goalMatrix) {
    return [
...
function safeFairOdds(probability) {
    if (probability <= 0)
        return 99.99;
    if (probability >= 1)
        return 1.001;
...
//# sourceMappingURL=market.calculator.js.map